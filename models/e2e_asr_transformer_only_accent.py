...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.output = torch.nn.Linear(512, self.odim) # mean + std pooling
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        # logging.warning("hs_pad.size()==>" + str(hs_pad.size()))
    ...
    def encode(self, x):
        ...
        logging.warning("x.size()===>" + str(x.size()))
    ...
    def recognize(self, x, recog_args, char_list=None, rnnlm=None, use_jit=False):
        ...
        logging.warning("x.size()===>" + str(x))
        enc_output = self.encode(x).unsqueeze(0)
        logging.warning("enc_output.size()===>" + str(enc_output.size()))
