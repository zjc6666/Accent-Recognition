...
feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/1/utt2spk scp:$sdata/JOB/cmvn.scp 'scp:head -10 $sdata/1/feats.scp |' ark:- |"
...
if [ $stage -le 2 ]; then
  ...
  #   nnet3-compute$suffix $gpu_opt $ivector_opts $frame_subsampling_opt \
    /home/maison2/kaldi/src/nnet3bin/nnet3-compute   $ivector_opts $frame_subsampling_opt \
     --frames-per-chunk=$frames_per_chunk \
     --extra-left-context=$extra_left_context \
     --extra-right-context=$extra_right_context \
     --extra-left-context-initial=$extra_left_context_initial \
     --extra-right-context-final=$extra_right_context_final \
     "$model" "$feats" ark:-  | logprob-to-post ark:- ark:- | fgmm-global-acc-stats-post ark:- \
	16266  "$feats  subsample-feats --n=3 ark:- ark:-|" ./1.acc
